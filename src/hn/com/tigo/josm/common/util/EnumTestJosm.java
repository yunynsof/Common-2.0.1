...
public enum EnumTestJosm {

	/** Constant that defines P_JOSM_JPA. */
	P_JOSM_JPA("JOSM_DS", EnumTestJosm.C_P_JOSM_JPA),

	/** Constant that defines P_JOSM_JPA_JTA_MANAGED. */
	P_JOSM_JPA_JTA_MANAGED("JOSM_DS.JtaManaged", EnumTestJosm.C_P_JOSM_JPA_JTA_MANAGED),

	/** Constant that defines P_JOSM_JPA_USER_NAME. */
	P_JOSM_JPA_USER_NAME("JOSM_DS.UserName", EnumTestJosm.C_P_JOSM_JPA_USER_NAME),

	/** Constant that defines P_JOSM_JPA_PASSWORD. */
	P_JOSM_JPA_PASSWORD("JOSM_DS.Password", EnumTestJosm.C_P_JOSM_JPA_PASSWORD),

	/** Constant that defines P_JOSM_JPA_JDBC_URL. */
	P_JOSM_JPA_JDBC_URL("JOSM_DS.JdbcUrl", EnumTestJosm.C_P_JOSM_JPA_JDBC_URL),

	/** Constant that defines P_JOSM_JPA_JDBC_DRIVER. */
	P_JOSM_JPA_JDBC_DRIVER("JOSM_DS.JdbcDriver", EnumTestJosm.C_P_JOSM_JPA_JDBC_DRIVER),

	P_MS_JPA("MS_DS", "new://Resource?type=DataSource"),

	P_MS_JPA_JTA_MANAGED("MS_DS.JtaManaged", "true"),

	P_MS_JPA_USER_NAME("MS_DS.UserName", "JOSM"),

	P_MS_JPA_PASSWORD("MS_DS.Password", "j0sM"),
	 ...
	 *            the value
	 */
	private EnumTestJosm(final String key, final String value) {
		this._key = key;
		this._value = value;
	}
