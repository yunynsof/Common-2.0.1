...
/**
 * The interface CrudServicePlatformMappingRemote contains the <Usage of this
 * class> for Common project.
 *
 * @author 
 * @version 1.0.0
 * @since Sep 1, 2017
...
public interface CrudServicePlatformMappingRemote {
	 ...
	 * @return the list
	 */
	public List<?> createQuery(final String namedQueryName, final Map<String, Object> parameters, final int resultLimit);
